        ...
        <section id="page-content">
            <div class="container">
                ...
                <div class="page-title">
                    <h1>Arama sonuçları ( <?php echo $toplam;?> )</h1>
                    <div class="breadcrumb float-left">
                        <ul>
                            <li><a href="#">Anasayfa</a>
                            </li>
                            <li><a href="#"><?php echo $q;?> kelimesine dair sonuçlar</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div id="blog" class="grid-layout post-3-columns m-b-30" data-item="post-item">
                    ...
                    <?php
                            ...
                            echo '<p style="width:100%; height:auto; padding-top:12px; padding-bottom:12px; background:#f5f5f5; border-radius:4px; color:#fc4e4c; font-size:16px; padding-left:12px; padding-right:12px;"><b>"'. $q .'"</b>&nbsp;kelimesine ait sonuç bulunamadı!</p>';
                        }
                    ?>
                    <!-- end: Post item-->
