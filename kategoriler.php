        ...
        <section id="page-content">
            <div class="container">
                ...
                <div class="page-title">
                    <h1><?php echo $katrow->kat_adi; ?> Dersleri</h1>
                ...
                <div id="blog" class="grid-layout post-3-columns m-b-30" data-item="post-item">
                    ...
                    <?php
                            ...
                            echo '<p style="color:white; width:100%; height:auto; padding-top:12px; padding-bottom:12px; background-color:#ff5232; padding-left:12px; padding-right:12px;; border-radius:4px;">Bu kategoriye ait henüz konu eklenmedi</p>';
                        }
                    ?>
                    <!-- end: Post item-->
