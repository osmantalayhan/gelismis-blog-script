...
<?php require_once 'inc/sol.php'; ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Onaylanmış Yorumlar</h1>
          <p>Onaylanmış Yorumlar</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Onaylanmış Yorumlar</li>
          <li class="breadcrumb-item active"><a href="#">Onaylanmış Yorumlar Listesi</a></li>
        </ul>
      </div>
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <?php 
              ...
              if($sorgu->rowCount()){
            ?>
            <h3 class="tile-title">Onaylanmış Yorumlar ( <?php echo $toplam; ?> )</h3>
